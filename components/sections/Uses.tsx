...
import type { UsesGroupItem } from "@/lib/data/content"

export function Uses({ groups }: { groups: UsesGroupItem[] }) {
  return (
    <section
      id="uses"
      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-24">
        <header className="mb-10">
          ...
          <p className="mt-3 max-w-2xl text-muted-foreground">
            Hardware, OS, and software I actually reach for. No affiliate links,
            just opinions.
          </p>
        </header>
