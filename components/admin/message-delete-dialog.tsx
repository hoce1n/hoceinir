...
import { deleteMessage } from "@/app/admin/(shell)/messages/actions"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
      ...
      <AlertDialogContent className="border-border bg-card font-mono">
        <AlertDialogHeader>
          <AlertDialogTitle className="font-mono text-foreground">
            <span className="text-destructive">$ rm -rf</span> message/
            {senderName}
          </AlertDialogTitle>
          <AlertDialogDescription className="font-mono text-xs leading-relaxed text-muted-foreground">
            ...
            <span className="text-foreground">{senderName}</span>. This
