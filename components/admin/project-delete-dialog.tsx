...
import { deleteProject } from "@/app/admin/(shell)/projects/actions"
      ...
      <AlertDialogContent className="border-border bg-card font-mono">
        <AlertDialogHeader>
          <AlertDialogTitle className="font-mono text-foreground">
            <span className="text-destructive">$ rm -rf</span> ./{projectTitle}
          </AlertDialogTitle>
          <AlertDialogDescription className="font-mono text-xs leading-relaxed text-muted-foreground">
            This permanently removes{" "}
            <span className="text-foreground">{projectTitle}</span> from the
            projects index. This operation cannot be undone.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
